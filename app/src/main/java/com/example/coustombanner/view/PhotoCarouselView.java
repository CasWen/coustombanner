...
import com.example.coustombanner.R;
import com.example.coustombanner.utils.GlideImageLoader;
...
public class PhotoCarouselView extends FrameLayout {
    ...
    private static final int DELAY_SECONDS = 3000;//轮播间隔时间
    ...
    private ImageLoaderListener mImageLoader = new ImageLoaderListener() {
        ...
        public void onLoadImage(ImageView imageView, String url) {
            new GlideImageLoader().displayImage(mContext, url, imageCarouse);
     ...
     */
    public void setImageRes(List<String> imageList) {
        ...
        for (int i = 0; i < mCountInt; i++) {
            ...
            imageDots.setBackgroundResource(R.drawable.point_red_selector);
        ...
        for (int i = 0; i < mCountInt; i++) {
            ...
            if(null != mImageLoader){
                mImageLoader.onLoadImage(imageCarouse, imageList.get(i));
            }
